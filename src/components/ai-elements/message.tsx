...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "chat-message-content is-user:dark flex w-fit min-w-0 max-w-full flex-col gap-2 overflow-hidden",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-[22px] group-[.is-user]:bg-secondary group-[.is-user]:px-4 group-[.is-user]:py-2.5 group-[.is-user]:text-foreground",
