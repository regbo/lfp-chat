  ...
  const chatAgent = new Agent({
    ...
    instructions: ({ requestContext }) => {
      ...
      const chartInstructions =
        "For render_chart, pass the ordered tabular result from family_database as columns plus aligned rows, along with a concise description of the intended comparison. The chart tool's private local planner chooses labels and series.";
